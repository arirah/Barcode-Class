...
// 			Quiet Zone		Start Char				Encoded Data				Check Digit		Stop Char		Quiet Zone
        ...
        header("Content-type: image/gif");         // Let the browser know we're outputting a PNG image (change this line and the next for GIF, JPG, etc.)
        imagegif($img);              // Output the image
        imagedestroy($img);
    }
